...
class PCAAnalyzer:
    ...
    """
    def __init__(self, rnn_model, num_seq, seq_len, outputs):
        """
    ...
    def generate_data(self, dynamics_mode="full"):
        """
        ...
        rnn_data = self.rnn_model.generate_sequences(self.time_steps, dynamics_mode)
    ...
    def plot_2d_trajectory(self, num_points=1000, save_path=None):
        """
    ...
    def plot_3d_trajectory(self, num_points=1000, save_path=None):
        """
    ...
    def run_analysis(self, dynamics_mode="full", save_path=""):
        ...
        data = self.generate_data(dynamics_mode)
        
        # Create 2D plot
        print("Generating 2D PCA trajectory plot...")
        self.plot_2d_trajectory(save_path=f"{save_path}latent_trajectory_2d.pdf")
        
        # Create 3D plot
        print("Generating 3D PCA trajectory plot...")
        self.plot_3d_trajectory(save_path=f"{save_path}latent_trajectory_3d.html")
